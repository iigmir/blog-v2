...
class StaticSiteGenerator
{
    ...
    async read_directory()
    {
        ...
        try
        {
            ...
            {
            case "local":
                this.directory_files = await this.fs_handler.read_local_source_directory( source_directory );
                break;
            case "ajax":
                this.directory_files = await this.ajax_handler.read_source_directory( source_directory );
                break;
            default:
                break;
            }
